...
public class TodoNotificationService extends IntentService {
    public static final String TODOTEXT = "abcdef.acagild.todolist";
    public static final String TODOUUID = "abcdef.acagild.todonotificationserviceuuid";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        Log.d("TDNS : ", "onHandleIntent called");
