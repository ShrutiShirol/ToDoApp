...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String TODOITEM = "com.abcdef.MainActivity";
    ...
    public static final String SHARED_PREF_DATA_SET_CHANGED = "com.android.app.datasetchanged";
    public static final String CHANGE_OCCURED = "com.android.app.changeoccured";
    private int mTheme = -1;
    private String theme = "name_of_the_theme";
    public static final String THEME_PREFERENCES = "com.android.app.themepref";
    public static final String RECREATE_ACTIVITY = "com.android.app.recreateactivity";
    public static final String THEME_SAVED = "com.android.app.savedtheme";
    public static final String DARKTHEME = "com.android.app.darktheme";
    public static final String LIGHTTHEME = "com.android.app.lighttheme";
...
//        setUpTransitions();
    ...
    private void deleteAlarm(Intent i, int requestCode){
        if(doesPendingIntentExist(i, requestCode)){
            ...
            Log.d("MA : ", "PI Cancelled " + doesPendingIntentExist(i, requestCode));
        }
    }
